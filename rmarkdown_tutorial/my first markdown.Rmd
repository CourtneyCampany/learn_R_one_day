...
#read data
flowers <- read.csv("data/data1.csv")
...
```{r starwars,echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8,}
source("rmardown_tutorial/starwars_figure.R")
```

...
#R prints things on plots in the order you code them, so for practice I want you to put 
## regression line underneath points
## We will need to make an empty plot first
...
plot(frond_length_cm ~ lamina_area_cm2, data=traits,ylim=c(0, 180), xlim=c(0, 1800),
      ylab=FLlabel, xlab=LAlabel, type = 'n') #type ='n' sets empty plots
...
#points has the same formular as plotting, but just prints the points

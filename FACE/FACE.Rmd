...
3) **ANPP**. Here, we will define aboveground net primary productivity (ANPP) as the productivy of stemwood biomass production + fine twig production + seed production + leaf production. Visualize and evaluate mean ANPP for aCO^2^ and eCO^2^ treatments for 2021, 2022 & 2023. **ANPP must be reported in g C m^-2^ yr ^-1^**. Is there a CO^2^ effect? Why does this match/not match what you find in photosynthesis?
